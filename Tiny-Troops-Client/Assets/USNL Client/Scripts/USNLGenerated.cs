...
namespace USNL {
    ...
    public struct SetUnitLocationPacket {
        ...
        public SetUnitLocationPacket(int _unitUUID, Vector2 _targetTileLocation, Vector2 _position) {
            unitUUID = _unitUUID;
            targetTileLocation = _targetTileLocation;
            position = _position;
        }
    ...
    public static class PacketHandlers {
       public delegate void PacketHandler(USNL.Package.Packet _packet);
        ...
        public static void SetUnitLocation(Package.Packet _packet) {
            ...
            USNL.SetUnitLocationPacket setUnitLocationPacket = new USNL.SetUnitLocationPacket(unitUUID, targetTileLocation, position);
